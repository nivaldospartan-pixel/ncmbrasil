...
# --------------------------
# As abas de Consulta, Cálculo, NCM/IPI e IA Groqk
# (continua como no script anterior, usando buscar_sku_cache e buscar_titulo_cache)
